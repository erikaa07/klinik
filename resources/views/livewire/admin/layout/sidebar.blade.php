<div class="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex">
    <!-- Sidebar -->
    <aside class="w-64 bg-gray-900 text-gray-100 flex flex-col border-r border-gray-800 min-h-screen">
        <!-- Header -->
        <div class="px-6 py-5 flex items-center gap-3 border-b border-gray-800">
            ...
            <span class="text-xl font-bold tracking-tight">
                <a href="{{ route('dashboard') }}">Admin Klinik</a>
            </span>
        </div>
        ...
        <div class="px-6 py-4 border-t border-gray-800 mt-auto">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="w-full flex items-center justify-center gap-2 px-3 py-2 rounded bg-red-600 text-white hover:bg-red-700 transition font-semibold">
